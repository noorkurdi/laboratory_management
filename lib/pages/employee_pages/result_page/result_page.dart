...
class EmployeeResultPage extends StatelessWidget {
  const EmployeeResultPage({super.key});
  ...
  Future<dynamic> showResultDetails(BuildContext context, AppCubit appCubit,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Directionality(
                  textDirection: TextDirection.rtl,
                  child: Text(appCubit.pillsList[index]['result'],
                      style: TextStyle(
